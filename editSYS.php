...
<table class="table border0-table">
    ...
    <tbody>
        ...
        <tr id="Applicable" style="display:none;">
            ...
            <td>
                ...
                <label class="radio-inline">
                  <input type="radio" name="Applicable"  value="Userpc" <?php if($row['Applicable']== 'Userpc'){ echo "checked";} ?>>User Pc
                </label>
                <label class="radio-inline">
                  <input type="radio" name="Applicable" value="Server" <?php if($row['Applicable']== 'Server'){ echo "checked";} ?>>As Server
                  <!-- <?php //print_r($row);  ?> -->
                </label>
                </div>
            </td>
        </tr>
        <tr id="empl_code" style="display:none;">
                        ...
                        <option value="">select Employee</option>
                            <?php
                                ...
                                // while($row = mysqli_fetch_all($res)){ 
                                  echo $rw['emp_code']."==".$transid;
                                      if($rw['emp_code']==$row['device_allocated']){
        ...
        <tr id="devicealloted" style="display: none;">
            <td>Decive Allocated</td>
            <td>
			    <div class="form-group">
...
<script>
  ...
  $(document).ready(function(){
    ...
    if($('#AssetCategory').val() == 'System') {
      ...
      $('#Applicable').hide();
      // $("input[name='Applicable']:radio").removeAttr("checked");
		}
	});
  });
...
$(document).ready(function(){
  ...
  function appli(){
    // alert(appli);
    var appli1 = $("input[name='Applicable']").prop("checked"); 
    // alert(appli1);
    if(appli1 == true){
      alert(appli1);
     var appli = $("input[name='Applicable']").val();
      if(appli == 'Userpc'){
        alert(appli);
      $('#empl_code').show();
      $('#devicealloted').hide();
...
<script>
    $(document).ready(function () {
        function serv() {
            if ($('#AssetCategory').val() == 'Servers' || $('#AssetCategory').val() == 'laptop') {
                alert('ffff');
                $('#devicealloted').show();
                 $('#empl_code').hide();
            } else {
                 var appli2 = $("input[name='Applicable']:checked").val();
                if (appli2 == 'Userpc') {
                alert(appli2);
                $('#empl_code').show();
                $('#devicealloted').hide();
