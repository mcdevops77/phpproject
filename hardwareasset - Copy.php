	...
	<tr>
        ...
        <div class="hardware-group">
          ...
          <select class="form-control" name="hw_processor" id="hw_processor">
           ...
           <option value="Intel®core I5 @3.20GHZ">Intel®core I5  </option>
          <option value="Intel®Core I7 @3.2GHZ">Intel®Core I7 </option>
           <option value="Intel®core i3 @ 3.2GHZ">Intel®core i3 </option> 
           <option value="Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz">Intel(R) Xeon(R) CPU E5-2620 v3 @ 2.40GHz</option>
           <!-- <option value=">Intel®core I5 @3.00GHZ">Intel®core I5 @3.00GHZ</option>    -->
       </select>
        </div>
        </div>
		    </td>
      ...
      <tr>
        ...
        <td>
        	<div class="form-group">
    <label class="radio-inline">
      <input type="radio" name="item" value="Yes">Yes
    </label>
    <label class="radio-inline">
      <input type="radio" name="item" value="No">No
    </label>
</div>
</td>
</tr>
