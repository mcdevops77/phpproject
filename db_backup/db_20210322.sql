...
INSERT INTO `tbl_application_server_master` VALUES (1,'localserver','live','etvbnap','122.15.10.200','','etvbharatfa,etvbharatasswts, etvbnap','madhu','','on'),(2,'localserver','live','HRMS','172.17.20.178','','punch_system, contact_payroll_priya, contact_payroll','nageshwarao','','on'),(3,'localserver','live','offline server','172.17.15.103','','','','offline code dump','on'),(4,'localserver','live','nap application live','172.17.20.124','','','','all application stored','on'),(5,'localserver','live','Ros , documents, newspaper','172.17.21.98','','','','scanned documents, newspapers, ros','on'),(6,'localserver','live','mspt live','172.17.134.237','','nap, nap_accounts','raghava, sureshkumar','','on'),(7,'localserver','live','EENADU STORES','172.17.15.106','','eenadustores,eenadufa, fa','sharma','','on'),(8,'localserver','Testing','AWS LOCAL TESTING','172.17.15.28','','','','awstestng','');
...
INSERT INTO `tbl_asset_details` VALUES (1,'Servers','','etvbnap','EtvB','','PowerEdge R540','zxcvfgbhn','Centos','no','122.15.10.200',NULL,NULL,'2019-10-09','2019-10-25','etvb','Deployed'),(2,'System','User pc','9321821','Eenadu','DS-5064','ProDesk 6200 G4 MT','qwertyasdf','Windows-10','yes','172.17.12.128',NULL,NULL,'2019-10-09','2019-10-25','mc','Deployed'),(3,'System','Server','offline code server','UKML','','HP Pro 3330 MT','INA216TQ1P','RHEL','yes','172.17.15.103',NULL,NULL,'2020-09-10','2020-09-20','mc','Deployed'),(4,'Servers','','HRMS','Eenadu','DS-5707','ProLiant DL380 Gen7','SGH201X483','Centos','no','172.17.20.178',NULL,NULL,'2015-03-12','2015-03-20','1st floor eenadu server room','Deployed'),(5,'Servers','','mspt live','Eenadu','DS-8888','ProLiant ML150 G6','SGH938X921','RHEL','no','172.17.134.237',NULL,NULL,'2015-03-10','2015-03-25','3rd floor server room','Deployed'),(6,'Servers','','Ros,newspaper, documents','Eenadu','DS-6678','ProLiant DL380 Gen9','CN75350CP6','RHEL','no','172.17.21.98',NULL,NULL,'2017-03-16','2017-03-23','1st floor eenadu server room','Deployed'),(7,'Servers','','nap application live','Eenadu','DS-10244','ProLiant DL380 Gen6','SGH028X1LR','RHEL','no','172.17.20.124',NULL,NULL,'2015-03-12','2015-03-25','1st floor eenadu server room','Deployed'),(8,'System','Server','cls&pp Sync','Eenadu','DS-1723','Core 2 Duo','mmnooippl','Windows-7','yes','172.17.20.159',NULL,NULL,'2018-02-14','2018-02-22','mc','Deployed'),(9,'System','Server','cls&pp Sync','Eenadu','DS-0909','Dell->7040','PLOKIMJNU','Windows-10','yes','172.17.20.159',NULL,NULL,'2018-06-20','2021-03-08','mc','Deployed'),(10,'Servers','','EENADU STORES','Eenadu','DS-12345','ProLiant DL380 Gen6','SGH020XLVY','Centos','no','172.17.15.106',NULL,NULL,'2019-08-20','2019-08-22','1st floor eenadu server room','Deployed'),(11,'System','Server','AWS LOCAL TESTING','Eenadu','DS-1112','Dell->7040','FG1HXH2','Centos','yes','172.17.15.28',NULL,NULL,'2019-11-20','2019-11-23','1st floor eenadu server room','Deployed');
...
INSERT INTO `tbl_asset_monitoring` VALUES (1,'System','','cls&pp Sync','Regular Mointoring','Core 2 Duo','172.17.20.159','1','1','OLD SYSTEMS','','2021-03-08','MC','scrap'),(2,'System','','cls&pp Sync','Regular Mointoring','Dell->7040','172.17.20.159','0','0','new system replaced for sync','','2021-03-08','MC','Replaced');
...
INSERT INTO `tbl_hardwaredetails_master_new` VALUES (1,'System','','Hp','ProDesk 6200 G4 MT','Intel®Core(TM) i5-8500 CPU','4GB','1TB','','Deployed',NULL),(2,'Server','RackServer','Hp','ProLiant DL380 Gen6','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','16GB','2TB','','Deployed',NULL),(3,'Server','RackServer','Dell','PowerEdge R540','Intel(R) Xeon(R) CPU E5-2609 0 @ 2.40GHz','16GB','2TB','','Deployed',NULL),(4,'Server','RackServer','Hp','ProLiant DL380 Gen9','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','32GB','5TB','','Deployed',NULL),(5,'Server','RackServer','Hp','ProLiant DL380 Gen7','Intel(R) Xeon(R) CPU E5620 @ 2.40GHz','16GB','1.5TB','','Deployed',NULL),(6,'Server','TowerServer','Hp','ProLiant ML150 G6','Intel(R) Xeon(R) CPU E5504  @ 2.00GHz','8GB','500GB','','Deployed',NULL),(7,'Server','TowerServer','Hp','HP Pro 3330 MT','Intel(R) Core(TM) i3-2120 CPU @ 3.30GHz','4GB','500GB','','Deployed',NULL),(8,'System','','HCL','Core 2 Duo','Intel®core(TM)2 Duo CPU E7500','4GB','300GB','','Deployed',NULL),(9,'System','','Dell','Dell->7040','Intel®core(TM)I5-6600','4GB','500GB','','Deployed',NULL);
...
INSERT INTO `tbl_software_ast_master` VALUES (1,'Operating System','windows-7','QPCFW-ZXCDS-MKIU-GGCT9','6months validity','Pending','');
...
-- Dump completed on 2021-03-22 16:58:04
