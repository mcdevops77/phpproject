...
INSERT INTO `tbl_application_server_master` VALUES (1,'localserver','live','etvbnap','122.15.10.200','','etvbharatfa,etvbharatasswts, etvbnap','madhu','','on');
...
INSERT INTO `tbl_asset_details` VALUES (1,'Servers','','etvbnap','EtvB','','PowerEdge R540','zxcvfgbhn','Centos','no','122.15.10.200',NULL,NULL,'2019-10-09','2019-10-25','etvb','Deployed'),(2,'System','1','9321821','Eenadu','DS-5064','ProDesk 6200 G4 MT','qwertyasdf','Windows-10','yes','172.17.12.128',NULL,NULL,'2019-10-09','2019-10-25','mc','Deployed');
...
INSERT INTO `tbl_hardwaredetails_master_new` VALUES (1,'System','','Hp','ProDesk 6200 G4 MT','Intel®Core(TM) i5-8500 CPU','4GB','1TB','','Deployed'),(2,'Server','RackServer','Hp','ProLiant DL380 Gen6','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','16GB','2TB','','Deployed'),(3,'Server','RackServer','Dell','PowerEdge R540','Intel(R) Xeon(R) CPU E5-2609 0 @ 2.40GHz','16GB','2TB','','Deployed'),(4,'Server','RackServer','Hp','ProLiant DL380 Gen9','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','32GB','5TB','','Deployed');
...
-- Dump completed on 2021-03-20  2:28:34
