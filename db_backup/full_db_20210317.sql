...
INSERT INTO `tbl_asset_details` VALUES (1,'System','1','9321821','Eenadu','DS-5064','Intel®Core(TM) i5-8500 CPU','qwertyasdf','Windows-10','1','172.17.12.127',NULL,NULL,'2019-10-09','2019-10-25','mc'),(2,'System','0','pms','Eenadu','DS-5012','Intel®Core(TM) i5-8500 CPU',' zxcvfbghn','Centos','1','172.17.20.149',NULL,NULL,'2019-10-09','2020-02-12','mc'),(3,'Servers','','etvbnap','EtvB','','Intel(R) Xeon(R) CPU E5-2609 0 @ 2.40GHz','bbbghjklopoi','Centos','0','122.15.10.200',NULL,NULL,'2019-10-09','2019-10-25','etvb'),(4,'Servers','','stores','Eenadu','DS-5066','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','asdfgtrrer','Centos','1','172.17.15.106',NULL,NULL,'2019-10-09','2019-10-12','mc');
...
INSERT INTO `tbl_hardwaredetails_master_new` VALUES (1,'System','','Hp','ProDesk 6200 G4 MT','Intel®Core(TM) i5-8500 CPU','4GB','1TB',''),(2,'Server','RackServer','Hp','ProLiant DL380 Gen6','Intel(R)Xeon(R)CPU E5-2620v3@2.40GHz','16GB','2TB',''),(3,'Server','RackServer','Dell','PowerEdge R540','Intel(R) Xeon(R) CPU E5-2609 0 @ 2.40GHz','16GB','2TB','');
...
-- Dump completed on 2021-03-17 12:35:57
