...
--
-- Table structure for table `tbl_accessioress`
--

DROP TABLE IF EXISTS `tbl_accessioress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_accessioress` (
...
--
-- Dumping data for table `tbl_accessioress`
--

LOCK TABLES `tbl_accessioress` WRITE;
/*!40000 ALTER TABLE `tbl_accessioress` DISABLE KEYS */;
INSERT INTO `tbl_accessioress` VALUES (6,'Ram','DDR2-2GB',0,'HMT325U6BFR8C-H9');
/*!40000 ALTER TABLE `tbl_accessioress` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_assets_new` VALUES (2,'Eenadu','System','DS-10556','Dell','Dell -> 3020','i5-5th Gen','zxcdwqe','Windows-10','user',1,'siva','172.17.12.107','2020-12-24','2020-12-24','RFC'),(3,'Eenadu','System','DS-10556','lenovo','Core2Duo','i5-5th Gen','zxcdwqe','Centos','user',1,'siva','172.17.12.107','2020-12-24','2020-12-24','RFC'),(4,'MC','Servers','DS-10558','Dell','Dell -> 7070','i5-5th Gen','zxcdwqe','RHEL','user',0,'siva','172.17.12.107','2020-12-24','2020-12-24','RFC'),(22,'Eenadu','Servers','DS-1020','Hp','Core2Duo','intel@i7','asdfg22','Fedora','usr',0,'test','172.17.12.10','2020-12-05','2020-12-12','mc'),(23,'Eenadu','System','DS-3867','Dell','Dell -> 7040','Intel(R)Core(TM)i5@3.30GHz,4GB,500GB','zxcvfdsa','Windows-10','devp',0,'siva','172.17.12.128','2020-12-25','2020-12-18','mc'),(24,'Eenadu','System','DS-3867','Dell','Dell -> 7040','Intel(R)Core(TM)i5@3.30GHz,4GB,500GB','zxcvfdsa','Windows-10','devp',0,'siva','172.17.12.128','2020-12-25','2020-12-18','mc'),(25,'Eenadu','Servers','DS-10200','Hp','Core2Duo','Intel(R)Core(TM)i5@3.30GHz,4GB,500GB','zxcqwert','Fedora','Nap',0,'nap live','172.17.20.124','2020-12-21','2020-12-29','mc'),(26,'Eenadu','Servers','DS-10200','Hp','Core2Duo','Intel(R)Core(TM)i5@3.30GHz,4GB,500GB','zxcqwert','Fedora','Nap',0,'nap live','172.17.20.124','2020-12-21','2020-12-29','mc'),(27,'MC','Servers','DS-10208','HCL','Core2Duo','intel@i3','zxcqwert','Windows-7','sync',0,'napsync','172.17.12.123','2020-12-19','2020-12-05','mc'),(28,'MC','System','DS-1245','HCL','Core2Duo','intel@i3,8GB,500GB','qedfgbn-cjklio-mnhy6','Fedora','network',0,'testing','172.17.12.1','2021-01-02','2021-01-07','Mc'),(29,'MC','System','DS-1245','HCL','Core2Duo','intel@i3,8GB,500GB','qedfgbn-cjklio-mnhy6','Fedora','network',0,'testing','172.17.12.1','2021-01-02','2021-01-07','Mc');
...
--
-- Table structure for table `tbl_new_accessioress`
--

DROP TABLE IF EXISTS `tbl_new_accessioress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_new_accessioress` (
...
--
-- Dumping data for table `tbl_new_accessioress`
--

LOCK TABLES `tbl_new_accessioress` WRITE;
/*!40000 ALTER TABLE `tbl_new_accessioress` DISABLE KEYS */;
INSERT INTO `tbl_new_accessioress` VALUES (1,'Ram','DDR2-2GB',0,'HMT325U6BFR8C-H9');
/*!40000 ALTER TABLE `tbl_new_accessioress` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-01-02 21:10:37
