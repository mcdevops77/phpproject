...
exit; {
	...
	if(!empty($id)){
	 ...
	 $sql = ("INSERT INTO tbl_assets_new_td (Ast_category, Applicable, Ast_belongs,  Ast_dvc_code, make_type, model, hardware_details, device_serial_no, OS, device_allocated, is_item_refundable, reg_user, Allocated_ipaddress, dvc_recv, dvc_put_to_user, Ast_location)
 
		VALUES ('$AssetCategory', '$Appli', '$Assetbelongs',  '$Assetdevicecode', '$Make_type', '$model', '$hw_details', '$deviceserialno', '$OS',
		'$dvc_alloted', '$item', '$reg_user', '$reg_ipaddress', '$ddate', '$pdate', '$Ast_location') ");
